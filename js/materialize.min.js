...
(jQuery.easing.jswing = jQuery.easing.swing),
      ...
      (i.isWindow = function (t) {
        ...
        (i.queue = function (t, n, a) {
          ...
          if (t) {
            ...
            var o = i.data(t, n);
            return a
              ? (!o || i.isArray(a) ? (o = i.data(t, n, r(a))) : o.push(a), o)
              : o || [];
          }
        }),
  ...
  (function (t) {
    ...
    return (function (t, e, i, n) {
      ...
      function r(t) {
        return (
          g.isWrapped(t) ? (t = [].slice.call(t)) : g.isNode(t) && (t = [t]), t
        );
      }
      function o(t) {
      ...
      function c(t) {
        if (t)
          for (
            var e = new Date().getTime(), i = 0, a = b.State.calls.length;
            a > i;
            i++
          )
            if (b.State.calls[i]) {
              ...
              for (
                var h = Math.min((e - u) / l.duration, 1), v = 0, m = s.length;
                m > v;
                v++
              ) {
                var y = s[v],
                ...
                if (o(w)) {
                  ...
                  l.visibility !== n &&
                    "hidden" !== l.visibility &&
                    x.setPropertyValue(w, "visibility", l.visibility);
                  for (var T in y)
                    if ("element" !== T) {
                      var O,
                        A = y[T],
                        P = g.isString(A.easing)
                          ? b.Easings[A.easing]
                          : A.easing;
                      if (1 === h) O = A.endValue;
                      else if (
                        ((O =
                          A.startValue + (A.endValue - A.startValue) * P(h)),
                        !p && O === A.currentValue)
                      )
                        continue;
                      ...
                      var I = x.setPropertyValue(
                        ...
                        T,
                        A.currentValue +
                          (0 === parseFloat(O) ? "" : A.unitType),
                        A.rootPropertyValue,
                        A.scrollData
                      );
                      x.Hooks.registered[T] &&
                        (o(w).rootPropertyValueCache[E] = x.Normalizations
                          .registered[E]
                          ? x.Normalizations.registered[E](
                              "extract",
                              null,
                              I[1]
                            )
                  ...
                  l.mobileHA &&
                    o(w).transformCache.translate3d === n &&
                    ((o(w).transformCache.translate3d = "(0px, 0px, 0px)"),
                    (k = !0)),
                    k && x.flushTransformCache(w);
                }
              }
              l.display !== n &&
                "none" !== l.display &&
      ...
      function d(t, e) {
        ...
        for (
          ...
          if (
            ...
            f.each(x.Lists.transforms3D, function (t, e) {
              ...
              o(d).transformCache[e] !== n &&
                new RegExp("^\\(" + i + "[^.]").test(a) &&
                ((p = !0), delete o(d).transformCache[e]);
            }),
              r.mobileHA && ((p = !0), delete o(d).transformCache.translate3d),
          ...
          s && r.loop !== !0 && s(a),
            r.loop !== !0 ||
              e ||
              (f.each(o(d).tweensContainer, function (t, e) {
                /^rotate/.test(t) &&
      ...
      var f,
        ...
        v = !1;
      if (
        (t.fn && t.fn.jquery ? ((f = t), (v = !0)) : (f = e.Velocity.Utilities),
        8 >= p && !v)
      )
        throw new Error(
      ...
      var x = (b.CSS = {
        ...
        Hooks: {
          ...
          register: function () {
            for (var t = 0; t < x.Lists.colors.length; t++) {
              var e =
                "color" === x.Lists.colors[t] ? "0 0 0 1" : "255 255 255 1";
          ...
          extractValue: function (t, e) {
            ...
            if (i) {
              var n = i[0],
                a = i[1];
              return (
                (e = x.Hooks.cleanRootPropertyValue(n, e)),
          ...
          injectValue: function (t, e, i) {
            ...
            if (n) {
              var a,
                ...
                s = n[1];
              return (
                (i = x.Hooks.cleanRootPropertyValue(o, i)),
                    ...
                    case "extract":
                      ...
                      if (x.RegEx.wrappedValueAlreadyExtracted.test(a)) r = a;
                        ...
                        /^[A-z]+$/i.test(a)
                          ...
                          ? (o = "rgb(" + x.Values.hexToRgb(a).join(" ") + ")")
          ...
          prefixCheck: function (t) {
            ...
            for (
              ...
              if (
                ...
                g.isString(b.State.prefixElement.style[a]))
              )
        ...
        getPropertyValue: function (t, i, a, r) {
            ...
            if (8 >= p) l = f.css(t, i);
              ...
              if (
                ...
                if (
                  "height" === i &&
                  "border-box" !==
                    x.getPropertyValue(t, "boxSizing").toString().toLowerCase()
                ) {
                  var c =
                    t.offsetHeight -
                    (parseFloat(x.getPropertyValue(t, "borderTopWidth")) || 0) -
                    (parseFloat(x.getPropertyValue(t, "borderBottomWidth")) ||
                      0) -
                ...
                if (
                  ...
                  var d =
                    t.offsetWidth -
                    (parseFloat(x.getPropertyValue(t, "borderLeftWidth")) ||
                      0) -
                    (parseFloat(x.getPropertyValue(t, "borderRightWidth")) ||
                      0) -
              ...
              (h =
                ...
                (p || b.State.isFirefox) &&
                  "borderColor" === i &&
                  (i = "borderTopColor"),
                (l = 9 === p && "filter" === i ? h.getPropertyValue(i) : h[i]),
                ("" === l || null === l) && (l = t.style[i]),
                a();
            }
            if ("auto" === l && /^(top|right|bottom|left)$/i.test(i)) {
              var g = s(t, "position");
              ("fixed" === g || ("absolute" === g && /top|left/i.test(i))) &&
                (l = f(t).position()[i] + "px");
            }
            return l;
          }
          ...
          return (
            /^[\d-]/.test(l) ||
              (l =
                o(t) && o(t).isSVG && x.Names.SVGAttribute(i)
                  ? /^(height|width)$/i.test(i)
                    ? t.getBBox()[i]
                    : t.getAttribute(i)
                  : s(t, x.Names.prefixCheck(i)[0])),
      ...
      var k = function () {
        ...
        function s() {
          function t() {
                ...
                g.isArray(t)
                  ? ((i = t[0]),
                    ...
                    x.RegEx.isHex.test(t[1])
                      ? (r = t[1])
                      : ((g.isString(t[1]) && !x.RegEx.isHex.test(t[1])) ||
                          g.isArray(t[1])) &&
                        ((a = e ? t[1] : u(t[1], l.duration)),
                        t[2] !== n && (r = t[2])))
                  : (i = t),
                e || (a = a || l.easing),
                g.isFunction(i) && (i = i.call(s, T, S)),
                g.isFunction(r) && (r = r.call(s, T, S)),
                [i || 0, a, r]
              );
            }
            function p(t, e) {
            ...
            function h() {
              var t = {
                ...
                n =
                  t.position === j.lastPosition && t.myParent === j.lastParent,
              ...
              if (a && n)
                ...
                b.init(u),
                  ...
                  b.CSS.setPropertyValue(u, "paddingLeft", r + "em"),
                  (l.percentToPxWidth = j.lastPercentToPxWidth =
              ...
              return (
                null === j.remToPx &&
                  (j.remToPx =
                    parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16),
                null === j.vwToPx &&
            ...
            if ("scroll" === E) {
              var k,
                C,
                O,
                A = /^x$/i.test(l.axis) ? "Left" : "Top",
                q = parseFloat(l.offset) || 0;
              l.container
                ? g.isWrapped(l.container) || g.isNode(l.container)
                  ? ((l.container = l.container[0] || l.container),
                    (k = l.container["scroll" + A]),
                    (O = k + f(s).position()[A.toLowerCase()] + q))
                  : (l.container = null)
                : ((k = b.State.scrollAnchor[b.State["scrollProperty" + A]]),
                  (C =
                    b.State.scrollAnchor[
                      b.State[
              ...
              "none" === o(s).opts.display && (o(s).opts.display = "auto"),
                ...
                (l = f.extend({}, o(s).opts, l));
              var I = f.extend(!0, {}, o(s).tweensContainer);
              for (var _ in I)
                if ("element" !== _) {
                  var M = I[_].startValue;
                  (I[_].startValue = I[_].currentValue = I[_].endValue),
                    (I[_].endValue = M),
                    g.isEmptyObject(w) || (I[_].easing = l.easing),
                    b.debug &&
                      console.log(
              ...
              o(s).tweensContainer &&
                o(s).isAnimating === !0 &&
                (I = o(s).tweensContainer),
                f.each(y, function (e, i) {
                    ...
                    if (x.RegEx.isHex.test(r)) {
                      for (
                        var l = ["Red", "Green", "Blue"],
                          u = x.Values.hexToRgb(r),
                          c = s ? x.Values.hexToRgb(s) : n,
                          d = 0;
                        d < l.length;
                        d++
                      ) {
              ...
              for (var V in y) {
                ...
                if (
                  o(s).isSVG ||
                  x.Names.prefixCheck(N)[1] !== !1 ||
                  x.Normalizations.registered[N] !== n
                ) {
                  ((l.display !== n &&
                    null !== l.display &&
                    "none" !== l.display) ||
                    (l.visibility !== n && "hidden" !== l.visibility)) &&
                    /opacity|filter/.test(V) &&
                    !L &&
                    0 !== Q &&
                    (L = 0),
                    l._cacheValues && I && I[V]
                      ? (L === n && (L = I[V].endValue + I[V].unitType),
                        (R = o(s).rootPropertyValueCache[N]))
                      : x.Hooks.registered[V]
                      ? L === n
                        ? ((R = x.getPropertyValue(s, N)),
                          (L = x.getPropertyValue(s, V, R)))
                        : (R = x.Hooks.templates[N][1])
                      : L === n && (L = x.getPropertyValue(s, V));
                  var z,
                    W,
                    H,
                    X = !1;
                  if (
                    ...
                    (Q = parseFloat(Q) || 0),
                    "%" === W &&
                      (/^(fontSize|lineHeight)$/.test(V)
                        ? ((Q /= 100), (W = "em"))
                        : /^scale/.test(V)
                        ? ((Q /= 100), (W = ""))
                        : /(Red|Green|Blue)$/i.test(V) &&
                          ((Q = (Q / 100) * 255), (W = ""))),
                    /[\/*]/.test(X))
                  )
                    W = H;
                  ...
                  (d[V] = {
                    ...
                    b.debug &&
                      console.log(
                        "tweensContainer (" + V + "): " + JSON.stringify(d[V]),
                        s
                      );
                } else
                  b.debug &&
                    console.log(
                      "Skipping [" + N + "] due to a lack of browser support."
                    );
              }
              d.element = s;
            }
            d.element &&
              ...
              T === S - 1
                ? (b.State.calls.length > 1e4 &&
                    (b.State.calls = a(b.State.calls)),
                  b.State.calls.push([D, v, l, null, P.resolver]),
          ...
          b.mock !== !1 &&
            (b.mock === !0
              ...
              : ((l.duration *= parseFloat(b.mock) || 1),
                (l.delay *= parseFloat(b.mock) || 1))),
            (l.easing = u(l.easing, l.duration)),
            l.begin && !g.isFunction(l.begin) && (l.begin = null),
            l.progress && !g.isFunction(l.progress) && (l.progress = null),
            l.complete && !g.isFunction(l.complete) && (l.complete = null),
            l.display !== n &&
              null !== l.display &&
              ((l.display = l.display.toString().toLowerCase()),
              "auto" === l.display &&
                (l.display = b.CSS.Values.getDisplayType(s))),
            l.visibility !== n &&
              null !== l.visibility &&
              (l.visibility = l.visibility.toString().toLowerCase()),
            (l.mobileHA =
              l.mobileHA && b.State.isMobile && !b.State.isGingerbread),
            l.queue === !1
              ? l.delay
                ? setTimeout(t, l.delay)
                : t()
              : f.queue(s, l.queue, function (e, i) {
                  return i === !0
                    ? (P.promise && P.resolver(v), !0)
                    : ((b.velocityQueueEntryFlag = !0), void t(e));
                }),
            ("" !== l.queue && "fx" !== l.queue) ||
              "inprogress" === f.queue(s)[0] ||
              f.dequeue(s);
        }
        var l,
          p,
        ...
        if (
          (g.isWrapped(this)
            ? ((l = !1), (h = 0), (v = this), (p = this))
            : ((l = !0),
              (h = 1),
              (v = C ? arguments[0].elements : arguments[0])),
          (v = r(v)))
        ) {
          C
            ? ((y = arguments[0].properties), (w = arguments[0].options))
            : ((y = arguments[h]), (w = arguments[h + 1]));
          var S = v.length,
            T = 0;
            ...
            for (var A = O; A < arguments.length; A++)
              ...
              (!/^(fast|normal|slow)$/i.test(arguments[A]) &&
                ...
                ? g.isString(arguments[A]) || g.isArray(arguments[A])
                  ? (w.easing = arguments[A])
                  : g.isFunction(arguments[A]) && (w.complete = arguments[A])
                : (w.duration = arguments[A]);
          }
            ...
            case "stop":
              ...
              return (
                f.each(b.State.calls, function (t, e) {
                  e &&
                    f.each(e[1], function (i, a) {
                      var r = g.isString(w) ? w : "";
                      return w !== n && e[2].queue !== r
                        ? !0
                        : void f.each(v, function (e, i) {
                            i === a &&
                              (w !== n &&
                                (f.each(f.queue(i, r), function (t, e) {
                                  g.isFunction(e) && e(null, !0);
                                }),
                                f.queue(i, r, [])),
                              o(i) &&
                                "" === r &&
                                f.each(o(i).tweensContainer, function (t, e) {
              ...
              if (!f.isPlainObject(y) || g.isEmptyObject(y)) {
                if (g.isString(y) && b.Redirects[y]) {
                  var I = f.extend({}, w),
                    ...
                    M = I.delay || 0;
                  return (
                    I.backwards === !0 && (v = f.extend(!0, [], v).reverse()),
                    f.each(v, function (t, e) {
                      parseFloat(I.stagger)
                        ? (I.delay = M + parseFloat(I.stagger) * t)
                        : g.isFunction(I.stagger) &&
                          (I.delay = M + I.stagger.call(e, t, S)),
                        I.drag &&
                          ((I.duration =
                            parseFloat(_) ||
                ...
                return (
                  P.promise ? P.rejecter(new Error(V)) : console.log(V), t()
                );
              }
              E = "start";
          }
          ...
          var $,
            I = f.extend({}, b.defaults, w);
          if (((I.loop = parseInt(I.loop)), ($ = 2 * I.loop - 1), I.loop))
            for (var Q = 0; $ > Q; Q++) {
              var F = { delay: I.delay, progress: I.progress };
              Q === $ - 1 &&
                ((F.display = I.display),
          ...
          i.addEventListener("visibilitychange", function () {
            i.hidden
              ? ((C = function (t) {
                ...
                c())
              : (C = e.requestAnimationFrame || h);
          }),
        (t.Velocity = b),
        t !== e && ((t.fn.velocity = k), (t.fn.velocity.defaults = b.defaults)),
  ...
  !(function (t, e, i, n) {
    ...
    function z(t, e) {
      ...
      for (a = 0; a < o.length; )
        n[o[a].identifier] && s.push(o[a]),
          e & (Ot | At) && delete n[o[a].identifier],
          a++;
    ...
    var Qt = { mousedown: St, mousemove: Tt, mouseup: Ot },
      Ft = "mousedown",
    ...
    var Ht = { touchstart: St, touchmove: Tt, touchend: Ot, touchcancel: At },
      Xt = "touchstart",
    ...
    var Bt = { touchstart: St, touchmove: Tt, touchend: Ot, touchcancel: At },
    ...
    (Y.prototype = {
      ...
      dropRecognizeWith: function (t) {
        return r(t, "dropRecognizeWith", this)
          ? this
          : ((t = U(t, this)), delete this.simultaneous[t.id], this);
      },
      ...
      u(tt, Y, {
        ...
        process: function (t) {
          ...
          if (((this._input = t), !n || !i || (t.eventType & (Ot | At) && !r)))
            this.reset();
  ...
  (function (t) {
    (t.fn.collapsible = function (e) {
      ...
      return (
        ...
        this.each(function () {
          function i(t) {
            (r = a.find(".collapsible-header")),
              t.parent().toggleClass("active"),
              t.parent().hasClass("active")
                ? t.siblings(".collapsible-body").stop(!0, !1).slideDown({
                    duration: 350,
                    easing: "easeOutQuart",
                    queue: !1,
                  })
              ...
              r.not(t).parent().removeClass("active"),
              r
                .not(t)
                .parent()
          ...
          a.off("click.collapse", ".collapsible-header"),
            r.off("click.collapse"),
            e.non - accordion || "accordion" == o || void 0 == o
              ? (a.on("click.collapse", ".collapsible-header", function (e) {
                  i(t(e.currentTarget));
                }),
                i(r.filter(".active").first()))
              : r.each(function () {
    ...
    (t.fn.scrollTo = function (e) {
      ...
      (t.fn.dropdown = function (e) {
        ...
        (e = t.extend(i, e)),
          this.each(function () {
            function i() {
              void 0 != o.data("inDuration") &&
                (e.inDuration = o.data("inDuration")),
                void 0 != o.data("outDuration") &&
                  (e.outDuration = o.data("outDuration")),
                void 0 != o.data("constrainwidth") &&
                  (e.constrain_width = o.data("constrainwidth")),
                void 0 != o.data("hover") && (e.hover = o.data("hover")),
                void 0 != o.data("alignment") &&
                  (e.alignment = o.data("alignment")),
                void 0 != o.data("gutter") && (e.gutter = o.data("gutter")),
                void 0 != o.data("beloworigin") &&
                  (e.belowOrigin = o.data("beloworigin"));
            }
            function n() {
              ...
              var r = 0,
                u = e.gutter;
              "right" == e.alignment &&
                ((r = o.innerWidth() - s.innerWidth()), (u = -1 * u)),
                s.css(
                  a(o[0])
                    ? {
                        display: "block",
                ...
                s
                  .velocity(
                    { opacity: 1 },
                    { duration: e.inDuration, queue: !1, easing: "easeOutQuad" }
                  )
                  .velocity(
                    { height: l },
                    {
            ...
            e.hover
              ...
              : (o.unbind("click." + o.attr("id")),
                o.bind("click." + o.attr("id"), function (e) {
                  o[0] == e.currentTarget && (e.preventDefault(), n()),
                    t(document).bind("click." + s.attr("id"), function (e) {
                      !s.is(e.target) &&
                        !o.is(e.target) &&
                        !o.find(e.target).length > 0 &&
                        (r(), t(document).unbind("click." + s.attr("id")));
                    });
                })),
              o.on("open", n),
              o.on("close", r);
    ...
    t.fn.extend({
      openModal: function (e) {
        ...
        (e = t.extend(a, e)),
          ...
          t("#lean-overlay").css({ display: "block", opacity: 0 }),
          t(i).css({ display: "block", top: "4%", opacity: 0 }),
          t("#lean-overlay").velocity(
            { opacity: e.opacity },
            { duration: e.in_duration, queue: !1, ease: "easeOutCubic" }
          ),
          t(i).velocity(
            { top: "10%", opacity: 1 },
            {
      ...
      t.fn.extend({
        closeModal: function (e) {
          var i = { out_duration: 200, complete: void 0 },
            e = t.extend(i, e);
          t(".modal-close").off(),
            t("#lean-overlay").velocity(
              { opacity: 0 },
              { duration: e.out_duration, queue: !1, ease: "easeOutQuart" }
            ),
            t(this).fadeOut(e.out_duration, function () {
              t(this).css({ top: 0 }),
                t("#lean-overlay").css({ display: "none" }),
                "function" == typeof e.complete && e.complete(),
                t("#lean-overlay").remove();
            });
        },
      }),
      t.fn.extend({
      ...
      return this.each(function () {
        function e() {
          ...
          t("#materialbox-overlay").fadeOut(r, function () {
            ...
            o.velocity(
              { width: a, height: s, left: 0, top: 0 },
              { duration: r, queue: !1, easing: "easeOutQuad" }
            ),
            ...
            o.on("click", function () {
              ...
              (n = !1),
                ...
                o
                  ...
                  .data("width", u)
                  .data("height", c);
              var d = t('<div id="materialbox-overlay"></div>')
                .css({ opacity: 0 })
                .click(function () {
                  n === !0 && e();
                });
              ...
              var p = 0,
                ...
                m = 0;
              h > g
                ? ((p = c / u), (v = 0.9 * s), (m = 0.9 * s * p))
                : ((p = u / c), (v = 0.9 * l * p), (m = 0.9 * l)),
                o.hasClass("responsive-img")
                  ? o.velocity(
                      { "max-width": v, width: u },
                      {
                        duration: 0,
                          ...
                          o.css({ left: 0, top: 0 }).velocity(
                            {
                              ...
                              left:
                                ...
                                s / 2 -
                                o.parent(".material-placeholder").offset()
                                  .left -
                                v / 2,
                              top:
                                t(document).scrollTop() +
                                l / 2 -
                                o.parent(".material-placeholder").offset().top -
                                m / 2,
                            },
                            {
                              duration: a,
                      ...
                      .velocity(
                        {
                          ...
                          left:
                            t(document).scrollLeft() +
                            s / 2 -
                            o.parent(".material-placeholder").offset().left -
                            v / 2,
                          top:
                            t(document).scrollTop() +
                            l / 2 -
        ...
        function i(i) {
          ...
          s > u &&
            ...
            n
              ...
              .first()
              .css("bottom", p + "px"),
            i && n.children("img").first().css("display", "block");
        }
        var n = t(this);
        n.addClass("parallax"),
      ...
      init: function () {
        return this.each(function () {
          ...
          var n,
            ...
            l = 0;
          (n = t(r.filter('[href="' + location.hash + '"]'))),
            0 === n.length && (n = t(this).find("li.tab a.active").first()),
            0 === n.length && (n = t(this).find("li.tab a").first()),
            n.addClass("active"),
            (l = r.index(n)),
            0 > l && (l = 0),
            (a = t(n[0].hash)),
          ...
          e.is(":visible") &&
            (u.css({ right: o - (l + 1) * s }), u.css({ left: l * s })),
            t(window).resize(function () {
              (o = e.width()),
                (s = e.find("li").first().outerWidth()),
                0 > l && (l = 0),
    ...
    (t.fn.tooltip = function (e) {
      ...
      return (
        ...
        this.each(function () {
          ...
          u.appendTo(l),
            u.css({ top: 0, left: 0 }),
            t(this).off("mouseenter mouseleave"),
            t(this).on({
              mouseenter: function () {
                var t = o.data("delay");
                (t = void 0 == t || "" == t ? e.delay : t),
                  (i = 0),
                  (a = setInterval(function () {
                    if (((i += 10), i >= t && 0 == n)) {
                      (n = !0),
                        l.css({ display: "block", left: "0px", top: "0px" }),
                      ...
                      "top" === s
                        ...
                        : (l.css({
                          ...
                          (f = "+10px"),
                          u.css({ marginLeft: d / 2 - u.width() / 2 })),
                        (h = d / 8),
                        8 > h && (h = 8),
                        ("right" === s || "left" === s) &&
                          ((h = d / 10), 6 > h && (h = 6)),
          ...
          t(this).each(function () {
            function i() {
              (r = !1),
                ...
                "left" === e.edge
                  ? (t(".drag-target").css({ width: "", right: "", left: "0" }),
                    a.velocity(
                      { left: -1 * (e.menuWidth + 10) },
                      { duration: 200, queue: !1, easing: "easeOutCubic" }
                    ))
                  : (t(".drag-target").css({ width: "", right: "0", left: "" }),
                    a.velocity(
            ...
            240 != e.menuWidth &&
              ...
              a.hasClass("fixed") || a.css("left", -1 * (e.menuWidth + 10))),
              "left" != e.edge && a.addClass("right-aligned"),
              t("body").append(t('<div class="drag-target"></div>')),
              t(".drag-target").css(
                "left" === e.edge ? { left: 0 } : { right: 0 }
              ),
              a.hasClass("fixed") &&
                t(window).resize(function () {
                  t(window).width() > 1200 &&
                    a.attr("style") &&
                    (a.removeAttr("style"), a.css("width", e.menuWidth)),
                    0 != t("#sidenav-overlay").css("opacity") &&
                      o &&
                ...
                if ("touch" === n.gesture.pointerType) {
                  ...
                  if (
                    ...
                    "left" === e.edge
                      ...
                      : (r < t(window).width() - e.menuWidth / 2
                          ? (o = !0)
                          : r >= t(window).width() - e.menuWidth / 2 &&
                            (o = !1),
                        a.css("right", -1 * (r - e.menuWidth / 2))),
                    "left" === e.edge)
                  ) {
                    var l = r / e.menuWidth;
                    t("#sidenav-overlay").velocity(
  ...
  (function (t) {
        ...
        return (
          ...
          0 >= c
            ? (clearTimeout(o),
              ...
              (r = t.apply(n, a)),
              (n = a = null))
            : o || i.trailing === !1 || (o = setTimeout(l, c)),
          r
        );
      };
    }
    ...
    (t.scrollSpy = function (e, n) {
      ...
      return (
        l || (r.on("scroll", d), r.on("resize", d), (l = !0)),
        setTimeout(d, 0),
        e.on("scrollSpy:enter", function () {
          ...
          s[0]
            ? (t("a[href=#" + s[0].attr("id") + "]").removeClass("active"),
              e.data("scrollSpy:id") < s[0].data("scrollSpy:id")
                ? s.unshift(t(this))
                : s.push(t(this)))
            : s.push(t(this)),
    ...
    t(document).ready(function () {
      ...
      if (
        ...
        t(document).on("reset", function (i) {
          t(i.target).is("form") &&
            (t(this).find(e).removeClass("valid").removeClass("invalid"),
            t(this)
      ...
      t(".hiddendiv").css("width", t(a).width()),
        t(a).each(function () {
          t(this).val().length &&
            ((n = t(this).val()),
            (n = n.replace(/\n/g, "<br>")),
            i.html(n + "<br>"),
            t(this).css("height", i.height()));
        }),
      ...
      t(document).on("mousedown", s, function (e) {
        ...
        i.length <= 0 &&
          ((i = t('<span class="thumb"><span class="value"></span></span>')),
          t(this).append(i)),
          (o = !0),
        ...
        0 > n ? (n = 0) : n > a && (n = a),
          ...
          i.find(".value").html(t(this).children("input[type=range]").val());
      }),
        ...
        t(document).on("mousemove", s, function (e) {
          ...
          if (o) {
            ...
            0 > n ? (n = 0) : n > a && (n = a),
              ...
              i
                .find(".value")
                .html(t(this).children("input[type=range]").val());
          }
        }),
        ...
        (t.fn.material_select = function (e) {
          t(this).each(function () {
            if (
                ...
                a.find("li").each(function (i) {
                  ...
                  t(this).click(function () {
                    t(this).hasClass("disabled") ||
                      (n.find("option").eq(i).prop("selected", !0),
                      n.trigger("change"),
                      n.siblings("input.select-dropdown").val(t(this).text()),
              ...
              $select.before(s),
                t("body").append(a),
                $select.is(":disabled") || s.dropdown({ hover: !1 }),
                $select.addClass("initialized"),
                s.on("focus", function () {
                  t(this).trigger("open"),
                    (o = t(this).val()),
                    (selectedOption = a.find("li").filter(function () {
                      return t(this).text().toLowerCase() === o.toLowerCase();
                    })[0]),
                    activateOption(a, selectedOption);
                }),
                s.on("blur", function () {
                ...
                (onKeyDown = function (e) {
                  return 9 == e.which
                    ? void s.trigger("close")
                    : 40 != e.which || a.is(":visible")
                    ? void (
                        (13 != e.which || a.is(":visible")) &&
                        (e.preventDefault(),
                        (letter = String.fromCharCode(e.which).toLowerCase()),
                        letter &&
                          (filterQuery.push(letter),
                          (string = filterQuery.join("")),
                          (newOption = a.find("li").filter(function () {
                            return (
                              0 === t(this).text().toLowerCase().indexOf(string)
                            );
                          })[0]),
                          newOption && activateOption(a, newOption)),
                        13 == e.which &&
                          ((activeOption = a.find(
                            "li.active:not(.disabled)"
                          )[0]),
                          activeOption &&
                            (t(activeOption).trigger("click"),
                            s.trigger("close"))),
                        40 == e.which &&
                          ((newOption = a
                            .find("li.active")
  ...
  (function (t) {
    t.fn.slider = function (e) {
      var i = { indicators: !0, height: 400, transition: 500, interval: 6e4 };
      return (
        (e = t.extend(i, e)),
        this.each(function () {
          function i(t, e) {
          ...
          function n(t) {
            t >= s.length ? (t = 0) : 0 > t && (t = s.length - 1),
              ...
              l != t &&
                ...
                e.indicators && u.eq(l).removeClass("active"),
                s
                  .eq(t)
                  .velocity(
                    { opacity: 1 },
                ...
                e.indicators && u.eq(t).addClass("active"));
          }
          var a,
            r = t(this),
          ...
          if (
            (-1 != l && (a = s.eq(l)),
            400 != e.height && (r.height(e.height + 40), o.height(e.height)),
            s.find(".caption").each(function () {
              i(t(this), 0);
            }),
          ...
          a
            ...
            : (s
              ...
              (l = 0),
              (a = s.eq(l)),
              e.indicators && u.eq(l).addClass("active")),
            ...
            .bind("pan", function (t) {
              if ("touch" === t.gesture.pointerType) {
                ...
                ($curr_slide = o.find(".active")),
                  ...
                  4 === e && (i > r.innerWidth() / 2 || -0.65 > n)
                    ? (f = !0)
                    : 2 === e &&
                      (i < (-1 * r.innerWidth()) / 2 || n > 0.65) &&
                      (d = !0);
                var a;
                d &&
                  ((a = $curr_slide.next()),
                  0 === a.length && (a = s.first()),
                  a.velocity(
                    { opacity: 1 },
                    { duration: 300, queue: !1, easing: "easeOutQuad" }
                  )),
              ...
              e.each(function () {
                i.top <= a &&
                  ...
                  a > i.bottom &&
                    ...
                    t(this).css("top", i.bottom - s));
              });
            }
            var r = e(),
              o = t(this),
              s = t(this).offset().top;
            a(o, t(window).scrollTop()),
  ...
  (function (t) {
    t(document).ready(function () {
      showStaggeredList = function (e) {
        var i = 0;
        t(e).find("li").velocity({ translateX: "-100px" }, { duration: 0 }),
          t(e)
            .find("li")
            .each(function () {
              t(this).velocity(
        ...
        t(this)
          ...
          .bind("pan", function (e) {
            if ("touch" === e.gesture.pointerType) {
              ...
              a.velocity(
                ...
                4 === r && (o > a.innerWidth() / 2 || -0.75 > s)
                  ? (i = !0)
                  : 2 === r &&
                    (o < (-1 * a.innerWidth()) / 2 || s > 0.75) &&
                    (n = !0);
            }
          })
          .bind("panend", function (e) {
            if ("touch" === e.gesture.pointerType) {
              ...
              if (i || n) {
                var r;
                (r = i ? a.innerWidth() : -1 * a.innerWidth()),
                  a.velocity(
                    { translateX: r },
                    {
                      duration: 100,
  ...
  (function (t) {
    ...
    function e(r, o, l, d) {
      function f() {
        return e._.node(
          ...
          e._.node(
            ...
            e._.node(
              "div",
              e._.node("div", S.component.nodes(b.open), x.box),
              x.wrap
            ),
            x.frame
          ),
      ...
      function p() {
        k
          ...
          .addClass(x.input)
          .attr("tabindex", -1)
          .val(k.data("value") ? S.get("select", w.format) : r.value),
          w.editable ||
            k
            ...
            "mousedown click": function (e) {
              ...
              i != S.$root.children()[0] &&
                ...
                "mousedown" != e.type ||
                  ...
                  (e.preventDefault(), S.$root[0].focus()));
            },
          })
          .on({
            focus: function () {
          ...
          .on(
            ...
            function () {
              var e = t(this),
                ...
                a = s();
              (a = a && (a.type || a.href)),
                (n || (a && !t.contains(S.$root[0], a))) && S.$root[0].focus(),
                !n && i.nav
                  ? S.set("highlight", S.component.item.highlight, {
                      nav: i.nav,
                    })
                  : !n && "pick" in i
                  ? S.set("select", i.pick)
          ...
          (S._hidden = t(
            '<input type=hidden name="' +
              ...
              (k.data("value") || r.value
                ? ' value="' + S.get("select", w.formatSubmit) + '"'
                : "") +
              ">"
          )[0]),
      ...
      function v(t) {
        ...
        return 27 == e
          ? (S.close(), !1)
          : void (
              (32 == e || i || (!b.open && S.component.key[e])) &&
              (t.preventDefault(),
              t.stopPropagation(),
      ...
      function m(t) {
        t.stopPropagation(),
          "focus" == t.type && S.$root.addClass(x.focused),
          S.open();
      }
      if (!r) return e;
      var y = !1,
        ...
        S = (C.prototype = {
          ...
          start: function () {
            return b && b.start
              ...
              : ((b.methods = {}),
                ...
                w.formatSubmit && g(),
                p(),
                w.container ? t(w.container).append(S.$root) : k.after(S.$root),
                S.on({
          ...
          render: function (t) {
            return (
              t
                ? S.$root.html(f())
                : S.$root.find("." + x.box).html(S.component.nodes(b.open)),
              S.trigger("render")
            );
          },
          stop: function () {
            return b.start
              ? (S.close(),
                ...
                S.$root.remove(),
                k.removeClass(x.input).removeData(o),
                setTimeout(function () {
                  k.off("." + b.id);
                }, 0),
                (r.type = b.type),
                  ...
                  u
                    ...
                    .on("keydown." + b.id, function (i) {
                      ...
                      27 == n
                        ? S.close(!0)
                        : r != S.$root[0] || (!a && 13 != n)
                        ? t.contains(S.$root[0], r) &&
                          13 == n &&
                          (i.preventDefault(), r.click())
                        : (i.preventDefault(),
                          a
                            ? e._.trigger(S.component.key.go, S, [
                                e._.trigger(a),
                              ])
                            : S.$root
                                .find("." + x.highlighted)
          ...
          close: function (t) {
            return (
              t &&
                (S.$root.off("focus.toOpen")[0].focus(),
                setTimeout(function () {
          ...
          set: function (e, i, n) {
            ...
            if (((n = o && t.isPlainObject(i) ? i : n || {}), e)) {
              ...
              for (a in s)
                (r = s[a]),
                  a in S.component.item &&
                    (void 0 === r && (r = null), S.component.set(a, r, n)),
                  ("select" == a || "clear" == a) &&
                    k
                      .val("clear" == a ? "" : S.get(a, w.format))
                      .trigger("change");
              S.render();
            }
          ...
          get: function (t, i) {
            ...
            if (t in S.component.item) {
              if ("string" == typeof i) {
                ...
                return n
                  ? e._.trigger(S.component.formats.toString, S.component, [
                      i,
                      n,
                    ])
                  : "";
    ...
    function a(e, i, n) {
      if (t.isPlainObject(i)) for (var a in i) r(e, a, i[a]);
      else r(e, i, n);
    }
    function r(t, e, i) {
    ...
    return (
      ...
      (e._ = {
        group: function (t) {
          for (
            var i, n = "", a = e._.trigger(t.min, t);
            a <= e._.trigger(t.max, t, [a]);
            a += t.i
          )
    ...
    (i.prototype.set = function (t, e, i) {
      ...
      (i.prototype.create = function (t, i, n) {
        ...
        return (
          ...
          i == -1 / 0 || 1 / 0 == i
            ? (a = i)
            : e.isPlainObject(i) && r.isInteger(i.pick)
            ? (i = i.obj)
            : e.isArray(i)
            ? ((i = new Date(i[0], i[1], i[2])),
              (i = r.isDate(i) ? i : o.create().obj))
            : (i =
                r.isInteger(i) || r.isDate(i)
                  ? o.normalize(new Date(i), n)
                  : o.now(t, i, n)),
          {
      ...
      (i.prototype.createRange = function (t, i) {
        ...
        return (
          r.isInteger(t) || (t = a(t)),
          r.isInteger(i) || (i = a(i)),
          r.isInteger(t) && e.isPlainObject(i)
      ...
      (i.prototype.navigate = function (t, i, n) {
        ...
        if (l || u) {
          for (
            u
              ? ((r = i.year), (o = i.month), (s = i.date))
              : ((r = +i[0]), (o = +i[1]), (s = +i[2])),
              n && n.nav && c && c.month !== o && ((r = c.year), (o = c.month)),
              a = new Date(r, o + (n && n.nav ? n.nav : 0), 1),
              r = a.getFullYear(),
              o = a.getMonth();
            new Date(r, o, s).getMonth() !== o;
      ...
      (i.prototype.measure = function (t, e) {
        ...
        return (
          e
            ? "string" == typeof e
              ? (e = i.parse(t, e))
              : r.isInteger(e) && (e = i.now(t, e, { rel: e }))
            : (e = "min" == t ? -1 / 0 : 1 / 0),
          e
        );
      }),
      ...
      (i.prototype.validate = function (t, i, n) {
        var a,
          ...
          g =
            f &&
            u.item.disable.filter(function (t) {
              if (e.isArray(t)) {
        ...
        if (
          (!n || !n.nav) &&
          ((!f && u.disabled(i)) ||
            (f && u.disabled(i) && (g || a || o)) ||
            (!f && (i.pick <= p.pick || i.pick >= h.pick)))
        )
          for (
            f && !g && ((!o && d > 0) || (!a && 0 > d)) && (d *= -1);
            u.disabled(i) &&
            (Math.abs(d) > 1 &&
              (i.month < c.month || i.month > c.month) &&
              ((i = c), (d = d > 0 ? 1 : -1)),
            i.pick <= p.pick
              ? ((s = !0),
                (d = 1),
        ...
        return {
          ...
          toString: function (t, e) {
            ...
            return i.formats
              ...
              .map(function (t) {
                return (
                  r.trigger(i.formats[t], i, [0, e]) || t.replace(/^!/, "")
                );
              })
              .join("");
          },
      ...
      (i.prototype.isDateExact = function (t, i) {
        var n = this;
        return (r.isInteger(t) && r.isInteger(i)) ||
          ("boolean" == typeof t && "boolean" == typeof i)
          ? t === i
          : (r.isDate(t) || e.isArray(t)) && (r.isDate(i) || e.isArray(i))
          ? n.create(t).pick === n.create(i).pick
          : e.isPlainObject(t) && e.isPlainObject(i)
          ? n.isDateExact(t.from, i.from) && n.isDateExact(t.to, i.to)
          : !1;
      }),
      (i.prototype.isDateOverlap = function (t, i) {
        var n = this,
          a = n.settings.firstDay ? 1 : 0;
        return r.isInteger(t) && (r.isDate(i) || e.isArray(i))
          ? ((t = (t % 7) + a), t === n.create(i).day + 1)
          : r.isInteger(i) && (r.isDate(t) || e.isArray(t))
          ? ((i = (i % 7) + a), i === n.create(t).day + 1)
          : e.isPlainObject(t) && e.isPlainObject(i)
          ? n.overlapRanges(t, i)
          : !1;
      }),
      ...
      (i.prototype.nodes = function (t) {
        var e = this,
          ...
          v = function (n) {
            ...
            return (
              "short_months" == n && (a = i.monthsShort),
              i.selectMonths && void 0 == n
                ? r.node(
                    ...
                    (t ? "" : "disabled") +
                      " " +
                      r.ariaAttr({ controls: e.$node[0].id + "_table" }) +
                      ' title="' +
                      i.labelMonthSelect +
                      '"'
                  )
                : "short_months" == n
                ? null != l
                  ? r.node("div", a[l.month])
                  : r.node("div", a[c.month])
                : r.node("div", a[c.month], i.klass.month)
            );
          },
          m = function (n) {
            var a = c.year,
        ...
        return (
          ...
          r.node(
            "div",
            r.node("div", createWeekdayLabel(), "picker__weekday-display") +
              r.node("div", v("short_months"), i.klass.month_display) +
              r.node("div", createDayLabel(), i.klass.day_display) +
              r.node("div", m("raw"), i.klass.year_display),
                              ...
                              item: function (t) {
                                ...
                                var n = l && l.pick == t.pick,
                                  ...
                                  o =
                                    ...
                                    t.pick < f.pick ||
                                    t.pick > p.pick,
                                  h = r.trigger(e.formats.toString, e, [
                                    i.format,
                                    t,
                                  ]);
                                return [
            ...
            r.node(
              ...
              r.node(
                ...
                "type=button data-pick=" +
                  ...
                  " " +
                  r.ariaAttr({ controls: e.$node[0].id })
              ) +
                r.node(
                  "button",
                  i.clear,
