...
?>
            ...
            <div class="row">
                <div class="col s12 header">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li class="waves-effect waves-light hide-on-small-only"><a href="#" class="judul"><i class="material-icons md-3">gamepad</i>Daftar Game</a></li>
            ...
            <div class="row">
                <div class="container">
                    ...
                    <?php
                 $query1 = "SELECT a.*, b.nama_f
                 FROM tbl_game a
                 LEFT JOIN tbl_favorit b ON a.nama_game = b.nama_f
                 COLLATE utf8mb4_general_ci ORDER BY id_game DESC";
                    ...
                    ?>
                            <article class="article-wrapper">
                                <div class="rounded-lg container-project">
                                    <a href="upload/user/<?= $row['file'] ?>" target="_blank">
                                        <img class="img-card" src="upload/user/<?= $row['file'] ?>" alt="">
                                    </a>
                                </div>
                                <div class="project-info">
                                    <div class="flex-pr">
                                        <div class="project-title text-nowrap"><?= $row['nama_game'] ?></div>
                                    ...
                                    <div class="types">
                                        <span class="project-type-number">• <?= $no ?></span>
                                        <span style="background-color: rgba(165, 96, 247, 0.43); color: rgb(85, 27, 177);" class="project-type">• <?= $row['kategori'] ?></span>
                                        <?php 
                                        if ($row['nama_f']) {
                                        echo '<span class="project-type">• '. $row['nama_f'] .'</span>';
                                        }
                                        ?>
