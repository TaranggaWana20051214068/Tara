...
$cfg['Servers'][$i]['collation_connection'] = 'utf8mb4_general_ci';
$cfg['Servers'][$i]['character_set_server'] = 'utf8mb4';
$cfg['Servers'][$i]['force_default_collation'] = 'utf8mb4_general_ci';
